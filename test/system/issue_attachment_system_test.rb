...
module RedmicaS3
  class IssueAttachmentSystemTest < ApplicationSystemTestCase
    ...
    test 'create issue with attachments' do
      ...
      # Verify attachments are stored in S3
    ...
    test 'remove issue attachments' do
      issue = create_issue_with_attachments('text.txt')
      ...
      # Verify that the attachments are removed.
      ...
      issue.attachments.each do |attachment|
        refute verify_attachment_stored_in_s3(attachment)
      end
    end
